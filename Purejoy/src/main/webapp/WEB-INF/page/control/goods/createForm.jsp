...
<div>
	<form method="post" class="form-x" id="woGoodsCreateForm">
		...
		<div class="form-group">
			...
			<div class="field">
				<input type="text" class="input" id="uname" name="type"
					size="50" placeholder="请输入商品类型" data-validate="required:必填 " value="" />
			</div>
		</div>
		<div class="form-group">
			<div class="label">
			...
			<div class="field">
				<input type="text" class="input" id="password" name="price"
					size="50" placeholder="请输入商品价格" data-validate="required:必填 " value="" />
			</div>
		</div>
	<%-- 	
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="field">
				<input type="text" class="input" id="password" name="cycle"
					size="50" placeholder="请输入运送周期" data-validate="required:必填 " value="" />
			</div>
		</div>	
		...
		<div class="form-group">
			...
			<div class="field">
				<input type="text" class="input" id="password" name="description"
					size="50" placeholder="请输入商品描述" data-validate="required:必填 " value="" />
			</div>
		</div>
			<div class="form-group">
			<div class="label">
		...
		<div class="form-button">
			<button class="button bg-main icon-save" type="button"
				onclick="Wobb.submitGoodsCreateForm();">保存</button>
